...
The current parser baseline is `v0.3.0`, implemented in `defiant_parser_v0_3_0.py`.
...
- Current parser file: `defiant_parser_v0_3_0.py`
...
```bash
python defiant_parser_v0_3_0.py
```
